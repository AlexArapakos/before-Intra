...
<table align="center" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	<td align="left">&nbsp;Depth Frequency</td>
...
<div id="squareContent" class="squareContent">
  <div id="MagFreqTable">
	<table align="center" border="0" cellpadding="0" cellspacing="5">
	  <tr>
		...
		{
			$query = 'select count(quakeid), depth from quake_mag_catalog where source = :source group by depth ORDER BY depth DESC';
			...
			if ($statement) 
			{
				...
				if ($r) 
				{
					...
					{
						echo '<tr><td align="center"><input type="checkbox" name ="depth['.$macroCounter.']" id="depth['.$macroCounter.']" value="'.$row[1].'"/></td>';
  ...
  <table align="center" border="0" cellpadding="0" cellspacing="5">
	<tr>
	  <td align="center"><input name="sawQuakes" id="sawQuakes" value="Show" onfocus="this.className='buttonPress'" onblur="this.className='buttonNormal'" class="buttonNormal" onclick="sawQuakeDepthFreq()" type="button"/></td>
	  <td>&nbsp;</td>
