...
DragZoomControl.prototype.initButton_ = function(mapDiv) {
  ...
  DragZoomUtil.style([buttonDiv], {cursor: 'pointer', zIndex:0});
...
DragZoomControl.prototype.initialize = function(map) {
  ...
  DragZoomUtil.style([zoomDiv], {position: 'absolute', display: 'none', overflow: 'hidden', cursor: 'crosshair', zIndex: 0});
